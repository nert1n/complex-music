...
export default function Left() {
    ...
    return (
        <div className={cl.player__left} disabled={disabled}>
            <Link className={cl.player__logo} disabled={disabled} to={currentTrack.name}>
            ...
            <div className={cl.player__info} disabled={disabled}>
                <Link className={cl.player__name} disabled={disabled} to={currentTrack.name}>{currentTrack.name}</Link>
            ...
            <button className={cl.player__like} disabled={disabled} onClick={handleLikeChange}>
                <img className={cl.player__like_img} disabled={disabled} src={`/img/icons/heart/${currentTrack.liked ? "heart-liked" : "heart"}.svg`} alt="Heart" />
            </button>
        </div>
    )
}
